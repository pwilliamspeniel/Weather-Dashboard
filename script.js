...
//                 currentAirQualityData = airQualityData; // Store globally
//             } catch (error) {
...
//                 currentForecastData = forecastData; // Store globally
//             } catch (error) {
...
//     // Key fix: Use popupopen event with a slight delay
...
//     // Check if there's already a chart instance on this canvas and destroy it
...
function processWeatherAndTimeData(weatherData, timeData, airQualityData, forecastData) {
    ...
    // No need to update currentTimeData here, it's already set in fetchWeatherAndTimeData
